...
import Gpib
params = [
    {"name": "AQ820x-422 GPIB Address", "type": "int", "limits": (1, 32), "value": 4},
    {"name": "AQ820x-422 Slot", "type": "int", "values": {1, 2, 3}, "value": 3},
    {"name": "AQ820x-422 Bank", "type": "int", "values": {1, 2}, "value": 1},
]
            ...
            for item in self.p:
                if "value" in item:
                    ...
                    if "ddress" in name:
                        ...
                        slot = value
            print(
                "config from list addr %d, slot %d, ch %d" % (gpibaddress, slot, bank)
            )
