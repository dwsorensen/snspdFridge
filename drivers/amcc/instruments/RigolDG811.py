...
class RigolDG811(object):
    """Python class for the Rigol DG811 series arbitrary waveform
    generators, written by Bakhrom oripov"""
    ...
    def setup_arb_wf(self, t = [0.0, 1e-3, 3e-3, 8e-3], v = [0.0,1.0, 0.2, 2.0], num_pts = 1000, channel = 1):
        ...
        self.write('DATA:DAC16 VOLATILE, ' + data_msg) # Form of "DATA VOLATILE, 1, .67, .33, 0, -.33", p200 user's guide
        self.write('DATA:POIN:INT LIN') # Set it to linearly interpolate between points
