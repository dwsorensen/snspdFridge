...
class Agilent34970a_34904A(object):
    """ Python class for Agilent 34970 DAQ 4x8 switch matrix 34904A
    written by Dana Rampini """
    ...
    def open_rowcol(self, row, col, slot = 1):
        self.write(f'ROUTe:OPEN (@{slot}{row}{col})') #closes channel, can be a list
        
    def close_rowcol(self, row, col, slot = 1):
        self.write(f'ROUTe:CLOSe (@{slot}{row}{col})') #closes channel, can be a list
    
    def open_all(self):
        self.write(f'ROUTe:OPEN (@111:148)')
